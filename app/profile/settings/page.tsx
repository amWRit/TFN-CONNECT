...
import { Bell, Mail, User, Briefcase, School, Users, Newspaper } from "lucide-react";
...
export default function ProfileSettingsPage() {
	...
	return (
		<div className="max-w-2xl mx-auto p-8 bg-gradient-to-br from-yellow-50 via-blue-50 to-white rounded-2xl shadow-xl mt-10 animate-fade-in">
			<h1 className="text-4xl font-extrabold mb-2 flex items-center gap-3 text-blue-600">
			...
			<div className="mb-3 p-3 bg-blue-100 border border-blue-300 rounded text-blue-800 flex items-center gap-2">
				<span>
